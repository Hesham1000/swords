...
const LAME_VARIANTS: Record<string, string[]> = {
  "stm-kings": ["blue", "rainbow"],
};
...
const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const handleProductTypeChange = (e: ChangeEvent<HTMLSelectElement>) => {
    ...
    setFormData((prev) => ({
      ...
      model: "",
      variant: "",
      subCategory: "", // Reset subCategory on type change
      hand: "", // Reset hand on type change
    }));
  };
  ...
  return (
    <div className="product-form-container">
      <form onSubmit={handleSubmit} className="product-form">
          ...
          <div className="form-grid">
                  ...
                  <>
                    <label className="checkbox-logic">
                      <input 
                        ...
                        name="category" 
                        value="Epée" 
                        checked={formData.category.includes("Epée")} 
                        onChange={handleChange} 
                        disabled={loading}
                      />
                    ...
                    <label className="checkbox-logic">
                      <input 
                        ...
                        name="category" 
                        value="Foil" 
                        checked={formData.category.includes("Foil")} 
                        onChange={handleChange} 
                        disabled={loading}
                      />
                      <div className="checkbox-visual"></div>
                  ...
                  <>
                    ...
                    <label className="checkbox-logic">
                      <input 
                        ...
                        name="category" 
                        value="Sabre" 
                        checked={formData.category.includes("Sabre")} 
                        onChange={handleChange} 
                        disabled={loading}
                      />
                      <div className="checkbox-visual"></div>
            ...
            <div className="form-group">
              ...
              <select
                ...
                required
                disabled={loading || ["wire", "grip", "guard_padding", "french_pommel", "nut", "point", "screws", "point_contact_springs", "socket", "insulating_tube", "body_wire", "cable", "pin"].includes(formData.productType)}
              >
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
              ...
              <>
                ...
                <div className="form-group">
                  ...
                  <select name="material" value={formData.material || ""} onChange={handleChange} disabled={loading}>
                    ...
                    {/* <option value="Other">Special Composite</option> */}
                  </select>
                </div>
            ...
            {formData.productType === "wire" && null}
            ...
            {formData.productType === "socket" && (
              <div className="form-group">
                ...
                <select
                  name="subCategory"
                  value={formData.subCategory || "standard"}
                  onChange={handleChange}
                  required
                  disabled={loading}
                >
          ...
          <div className="form-grid">
            <div className="form-group full-width">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Describe technical features, sizing advice..."
                rows={3}
                disabled={loading}
              />
            </div>
              ...
              <div className="media-upload-zone">
                <label className={`upload-trigger ${formData.images.length + existingImages.length >= 5 ? 'disabled' : ''}`}>
                  ...
                  <input
                    ...
                    disabled={loading || (formData.images.length + existingImages.length >= 5)}
                    hidden
                  />
                </label>
                ...
                <div className="media-previews">
                  {existingImages.map((src, index) => (
                    <div key={`existing-${index}`} className="media-card">
                      ...
                      <button type="button" className="remove-media" onClick={() => removeImage(index, true)} disabled={loading}>
                        <X size={12} />
                      </button>
                  ...
                  {imagePreviews.map((preview, index) => (
                    <div key={`new-${index}`} className="media-card new">
                      ...
                      <button type="button" className="remove-media" onClick={() => removeImage(index, false)} disabled={loading}>
                        <X size={12} />
                      </button>
      ...
      <style jsx>{`
        ...
        .checkbox-logic:hover {
          background: rgba(255, 255, 255, 0.05);
        }
        .checkbox-logic input {
          display: none;
        }
        .checkbox-visual {
          width: 20px;
        ...
        .checkbox-logic:hover .checkbox-visual {
          border-color: var(--accent-blue);
          box-shadow: 0 0 10px rgba(59, 130, 246, 0.2);
        }
        .checkbox-logic input:checked + .checkbox-visual {
        ...
        .checkbox-logic input:checked + .checkbox-visual::after {
          opacity: 1;
        }
        .checkbox-logic span {
          font-family: var(--font-display);
